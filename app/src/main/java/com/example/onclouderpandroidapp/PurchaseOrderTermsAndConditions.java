...
public class PurchaseOrderTermsAndConditions extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_purchase_order_terms_and_conditions);
		...
		try {
			...
			JSONArray termsAndCondition = response
					.getJSONArray("purchaseOrderTerms");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.purchase_order_terms_and_conditions,
				menu);
		return true;
	}
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                Intent intent = new Intent(PurchaseOrderTermsAndConditions.this,
                                        HomeActivity.class);
