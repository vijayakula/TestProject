...
public class PieChartItemVsSalesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pie_chart_item_vs_sales);
		...
		try {
			...
			Toast.makeText(getApplicationContext(), "Pie2D", Toast.LENGTH_LONG)
					.show();
			...
			String summary = "<html>"
					...
					+ " var myChart = new FusionCharts( \"Pie2D\",\"myChartId\", \"300\",\"300\", \"0\", \"1\" );"
					+
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pie_chart_item_vs_sales, menu);
		return true;
	}
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                Intent intent = new Intent(PieChartItemVsSalesActivity.this,
                                        HomeActivity.class);
