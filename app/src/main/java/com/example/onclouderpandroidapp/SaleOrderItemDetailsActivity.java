...
public class SaleOrderItemDetailsActivity extends Activity {

	@SuppressLint("NewApi")
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_sale_order_item_details);
		...
		try {
			...
			JSONArray saleOrderItemDetails = response
					.getJSONArray("salesOrderDetails");
			...
			for (int i = 0; i < saleOrderItemDetails.length(); i++) {
				...
				String uom = saleOrderItemDetails.getJSONObject(i)
						.getString("UnitOfMeasurementNameUnique");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sale_order_item_details, menu);
		return true;
	}
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                Intent intent = new Intent(SaleOrderItemDetailsActivity.this,
                                        HomeActivity.class);
